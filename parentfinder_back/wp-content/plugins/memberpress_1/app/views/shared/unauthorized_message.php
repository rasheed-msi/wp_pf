...
<<<<<<< HEAD
  <?php else: ?>
    <span class="mepr-login-link"><a href="<?php echo $mepr_options->login_page_url(); ?>"><?php echo MeprHooks::apply_filters('mepr-unauthorized-login-link-text',__('Login', 'memberpress')); ?></a></span>
=======
