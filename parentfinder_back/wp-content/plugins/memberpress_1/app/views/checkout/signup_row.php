...
<<<<<<< HEAD
      <label for="<?php echo $line->field_key; ?>"><?php printf( '%1$s:%2$s', __(stripslashes($line->field_name), 'memberpress'), $required ); ?></label>
      <span class="cc-error"><?php ($line->required) /*here for email custom fields that are not required*/ ? printf(__('%s is Required', 'memberpress'), stripslashes($line->field_name)) : printf(__('%s is not valid', 'memberpress'), stripslashes($line->field_name)); ?></span>
=======
