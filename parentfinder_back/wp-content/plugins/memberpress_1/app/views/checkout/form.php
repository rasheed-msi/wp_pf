...
<<<<<<< HEAD
    <?php if( $product->register_price_action != 'hidden' ): ?>
      <div class="mp-form-row mepr_bold mepr_price">
        <?php $price_label = ($product->is_one_time_payment() ? __('Price:', 'memberpress') : __('Terms:', 'memberpress')); ?>
=======
...
<<<<<<< HEAD
            ...
            <span class="cc-error"><?php _e('Invalid Username', 'memberpress'); ?></span>
=======
...
<<<<<<< HEAD
      ...
      <div class="mp-form-row">
        <div class="mp-form-label">
          ...
          <span class="cc-error"><?php _e('Invalid Password', 'memberpress'); ?></span>
        </div>
      ...
      <div class="mp-form-row">
        <div class="mp-form-label">
          ...
          <span class="cc-error"><?php _e('Password Confirmation Doesn\'t Match', 'memberpress'); ?></span>
        </div>
...
<<<<<<< HEAD
            ...
            <span class="cc-error"><?php _e('Invalid Coupon', 'memberpress'); ?></span>
          </div>
