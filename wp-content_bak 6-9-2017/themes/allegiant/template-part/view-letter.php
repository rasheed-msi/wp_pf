            ...
            if ($letter_query->have_posts()) : while ($letter_query->have_posts()) : $letter_query->the_post();
                    ...
                    <div data-id="<?php echo $post_id; ?>" class="col-lg-6 col-md-6 col-sm-6 col-xs-12 articleColumn articlePost author-letter-container letter-<?php echo $post_id; ?>">
                        ...
                        <div class="articleItem">
                            ...
                            <?php endif; ?>
                                <div class="articleItemHead clearfix noBg"  id="letter-title-<?php echo $post_id; ?>"><?php echo (in_array($letter_label, $default_letter)) ? $default_letter[$letter_label] : get_the_title(); ?></div>
                        ...
                        <form id="letter-form" method="post" class="center-block">
                            <div id="letter-label-group" class="form-group has-float-label">
                                <select class="form-control" id="letter-label" name="letter-label" >
                                    ...
                                    <?php endforeach; ?>
                                    	<option value=""><?php _e('Our Family'); ?></option>
                                        <option value=""><?php _e('Our Holidays'); ?></option>
                                        <option value=""><?php _e('Our Home'); ?></option>
                                        <option value=""><?php _e('Our Promise'); ?></option>
                                        <option value=""><?php _e('Our Traditions'); ?></option>
                                        <option value=""><?php _e('Our Vacations'); ?></option>
                                        <option value=""><?php _e('Other'); ?></option>
                            ...
                            <div class="form-group has-float-label" id="selected-assoc">
                                <label for="associated_images">Associated Images</label>
                                <div class="row">
