...
class Widgets_Plugin_Admin_Settings {
	...
	public static function settings() {
		...
		echo ' ';
		echo __( 'This option is only provided as a convenience while you set up your site.', WIDGETS_PLUGIN_DOMAIN );
		echo ' ';
		echo __( 'It is recommended while you set up your widgets or when you work on changes.', WIDGETS_PLUGIN_DOMAIN );
		echo ' ';
