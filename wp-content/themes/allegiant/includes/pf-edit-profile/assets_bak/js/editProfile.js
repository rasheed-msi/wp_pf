...
var api_url = 'http://ctpf01.parentfinder.com/api_oauth/';
var access_token = '';
//console.log(access_token);
var aboutusGetUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/aboutus/27779";
//var aboutusGetUrl = api_url + "v1/editprofile/aboutus?access_token=" + access_token;
var contactUsGetUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/contactus/27779";;
var childPrefGetUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/childpreference/27779";
//var childPrefGetUrl = api_url + "v1/editprofile/childpreference?access_token=" + access_token;
var aboutusPostUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/saboutus";
//var aboutusPostUrl = api_url + "v1/editprofile/save/aboutus";
var contactusPostUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/scontactus";
//var contactusPostUrl = api_url + "v1/editprofile/save/contactus";
var childPrefPostUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/schildpreference";
//var childPrefPostUrl = api_url + "v1/editprofile/save/childpreference";
var getStatesUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/states";
var template_root_path = 'http://localhost/pfwp/parentfinder/wp-content/themes/allegiant/includes/pf-edit-profile/';
...
app.controller('TabsCtrl', ['$scope', '$http', '$location', function ($scope, $http, $window, $location) {
        console.log($scope.template_root_path, $scope);
        ...
        $scope.$watch('template_root_path', function(){
            template_root_path = $scope.template_root_path;
        })
        $scope.$watch('site_url', function () {
            aboutusGetUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/aboutus/27779";
            contactUsGetUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/contactus/27779";
            childPrefGetUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/childpreference/27779";
            aboutusPostUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/saboutus";
            contactusPostUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/scontactus";
            getStatesUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/states/";
            childPrefPostUrl = "http://localhost/pfwp/parentfinder/wp-json/pf/api/v1/schildpreference";
        });
