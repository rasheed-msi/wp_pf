...
function pf_journal_scripts() {
	...
	wp_register_script( 'pf-journal', get_template_directory_uri() . '/includes/js/pf-journal.js', array('jquery', 'tinymce_js'), '1.1.8', true );
...
add_action('wp_ajax_edit_journal', 'pf_journal_edit_func');
add_action('wp_ajax_nopriv_edit_journal', 'pf_journal_edit_func');
...
function pf_journal_edit_func(){//echo '<pre>';print_r($_POST);exit;
