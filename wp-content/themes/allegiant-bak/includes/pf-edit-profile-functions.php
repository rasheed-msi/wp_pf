...
function pf_edit_profile_scripts() {
    ...
    if(is_page(69)){
        //register & call stylesheets from pf edit profile component
            ...
            wp_enqueue_style('pf-edit-custom', get_template_directory_uri() . '/includes/pf-edit-profile/assets/css/custom.css', array(),1.2);
        ...
        //register & call js files from pf edit profile component
            ...
            wp_register_script('pf-edit-script', get_template_directory_uri() . '/includes/pf-edit-profile/assets/js/editProfile.js');
